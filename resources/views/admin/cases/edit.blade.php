                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.cases.update', ['type' => $type, 'id'=>$case->id])}}"
                                            method="POST"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" value="{{ $case->getTranslation('name', 'ar') }}" id="name_ar"
                                                                        class="form-control"
                                                                        placeholder="  "
                                                                        name="name_ar">
                                                                    @error("name_ar")
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" value="{{ $case->getTranslation('name', 'en') }}" id="name_en"
                                                                        class="form-control"
                                                                        placeholder="  "
                                                                        name="name_en">
                                                                    @error("name_en")
