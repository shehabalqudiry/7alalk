        ...
        <li class="nav-item"><a href="{{route('admin.dashboard')}}"><i class="la la-home"></i><span
            ...
            <a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.helpers')}}"
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href=""><i class="la la-male"></i>
                        ...
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('admin.users','doctor')}}"
                                data-i18n="nav.dash.ecommerce"> عرض الكل  </a>
                            </li>
            ...
            <a href=""><i class="la la-life-bouy"></i>
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{ route('admin.regions') }}"
                        data-i18n="nav.dash.ecommerce">عرض الكل  </a>
                    </li>
                    <li><a class="menu-item" href="{{ route('admin.regions.create') }}"
                        data-i18n="nav.dash.ecommerce"> اضافة منطقة</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                <a href=""><i class="la la-life-bouy"></i>
                    ...
                    <ul class="menu-content">
                        <li><a class="menu-item" href="{{ route('admin.countries') }}"
                            data-i18n="nav.dash.ecommerce">عرض الكل  </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href=""><i class="la la-life-bouy"></i>
                        ...
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{ route('admin.cats') }}"
                                data-i18n="nav.dash.ecommerce">عرض الكل  </a>
                            </li>
                            <li><a class="menu-item" href="{{ route('admin.cats.create') }}"
                    ...
                    <li class="nav-item">
                        <a href=""><i class="la la-life-bouy"></i>
                            ...
                            <ul class="menu-content">
                                <li><a class="menu-item" href="{{ route('admin.subcats') }}"
                                    data-i18n="nav.dash.ecommerce">عرض الكل  </a>
                                </li>
                                <li><a class="menu-item" href="{{ route('admin.subcats.create') }}"
                                    data-i18n="nav.dash.ecommerce"> اضافة قسم</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href=""><i class="la la-life-bouy"></i>
                                ...
                                <ul class="menu-content">
                                    <li><a class="menu-item" href="{{ route('admin.animals') }}"
                                        data-i18n="nav.dash.ecommerce">عرض الكل  </a>
                                    </li>
                                    <li><a class="menu-item" href="{{ route('admin.animals.create') }}"
                                        data-i18n="nav.dash.ecommerce"> اضافة حيوان</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href=""><i class="la la-life-bouy"></i>
                                        ...
                                        <ul class="menu-content">
                                            <li><a class="menu-item" href="{{-- route('admin.offers') --}}"
                                                data-i18n="nav.dash.ecommerce">عرض الكل  </a>
                                            </li>
