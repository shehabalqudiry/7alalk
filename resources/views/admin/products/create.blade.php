                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{route('admin.products.store')}}" method="POST"
                                        ...
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="ft-home"></i> بيانات اضافة الي المتجر
                                            </h4>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="type" class="form-control" id="">
                                                            <option value="حسب الغرض من الاستخدام">حسب الغرض من
                                                                الاستخدام</option>
                                                ...
                                                @foreach (config('translatable.lang') as $key => $lang)
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> الاسم بـ{{ $lang }}</label>
                                                        <input type="text" value="" id="name_{{ $key }}" class="form-control"
                                                            placeholder="  " name="name_{{ $key }}">
                                                        @error("name_{{ $key }}")
                                                        <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> وصف قصير بـ{{ $lang }} </label>
                                                        <input type="text" value="" id="short_desc_{{ $key }}" class="form-control"
                                                            placeholder="  " name="short_desc_{{ $key }}">
                                                        @error("short_desc_{{ $key }}")
                                                        <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> شرح وصف المنتج بـ{{ $lang }} </label>
                                                        <textarea name="long_desc_{{ $key }}" class="form-control" rows="15"
                                                            cols="20"></textarea>
                                                        @error("long_desc_{{ $key }}")
                                                        <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> شرح كيفية الاستخدام بـ{{ $lang }} </label>
                                                        <textarea name="how_used_{{ $key }}" class="form-control" rows="15"
                                                            cols="20"></textarea>
                                                        @error("how_used_{{ $key }}")
                                                        <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="subcat_id" class="form-control subcat"
                                                            id="subcat">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" value="" id="amount" class="form-control"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" value="" id="offer" class="form-control"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> السعر عند الشراء بة ياخد توصيل مجاني
                                                        </label>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" value="" id="end_date" class="form-control"
