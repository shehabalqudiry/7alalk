...
@section('title','تسجيل الدخول للوحة التحكم')
@section('content')
            ...
            <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                    <div class="card-title text-center">
                        <div class="p-1">
                            <img src="{{asset('Adminlook/images/logo/logo.png')}}" alt="LOGO" width="100" height="100"/>
                        ...
                        <form class="form-horizontal form-simple" action="{{route('admin.login')}}" method="post" novalidate>
                            ...
                            <fieldset class="form-group position-relative has-icon-left mb-0">
                                <input type="text" name="email" class="form-control form-control-lg input-lg"
                                    value="{{old('email')}}" id="email" placeholder="البريد الالكتروني">
                            ...
                            <button type="submit" class="btn btn-lg btn-block btn-info"><i class="ft-unlock"></i>
                                تسجيل الدخول
                            </button>
                        </form>
                    </div>
